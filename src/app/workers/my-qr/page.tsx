...
export default function MyQRCodePage() {
    ...
    return (
        <AppLayout>
            <div className="max-w-2xl mx-auto space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                ...
                <Card className="flex flex-col items-center justify-between text-center p-12 bg-white shadow-xl border-2">
                    <CardHeader className="p-0 mb-8">
                        ...
                        <p className="text-sm text-muted-foreground mt-1 capitalize">{workerProfile?.roleId} &bull; {workerProfile?.workerId}</p>
                    </CardHeader>
            ...
            <style jsx global>{`
                @media print {
                    .sidebar-container, header, nav, button, .print\\:hidden {
