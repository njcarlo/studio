...
import type { C2SGroup, Mentee } from '@/lib/data';
import { saveMentee, saveDevotion } from '@/actions/c2s';
...
interface Props {
    mentee: Mentee;
    /** Groups the mentee can be transferred into. */
    groups: C2SGroup[];
    onClose: () => void;
...
export default function DevotionalProgressModal({ mentee, groups, onClose, onSave }: Props) {
    ...
    async function handleSave() {
        ...
        // Persist the mentee's progress and log today's devotional entry.
        await saveMentee(mentee.id, {
