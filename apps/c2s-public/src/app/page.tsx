...
import { Card, CardContent, Button, Badge, Input } from "@studio/ui";
import {
  Select,
  SelectContent,
  SelectItem,
...
import { JoinGroupDialog, type JoinGroup } from "@/components/JoinGroupDialog";

const GroupFinderMap = dynamic(
  () => import("@/components/GroupFinderMap").then((m) => m.GroupFinderMap),
  {
    ssr: false,
    loading: () => (
...
export default function C2SPublicHomePage() {
    ...
    <div className="min-h-screen bg-gray-50">
      <header className="border-b bg-white">
        <div className="mx-auto max-w-7xl px-6 py-4 flex items-center gap-3">
          <img
            src={tenant.logoUrl || "/cog-logo.png"}
      ...
      <main className="mx-auto max-w-7xl px-6 py-8 space-y-6">
        <div className="space-y-3">
          ...
          <p className="text-muted-foreground max-w-2xl">
            Discover a Connect2Souls group near you — built for real friendships,
