...
function CoordinatorPanel({ coord, onClose }: { coord: C2SCoordinator; onClose: () => void }) {
    return (
        <>
            ...
            <div className="fixed top-0 right-0 bottom-0 z-[10000] w-[440px] max-w-full bg-white shadow-2xl flex flex-col overflow-hidden">
        ...
        <div>
            ...
            <div className="flex flex-wrap items-center gap-2 mb-5">
                <select
                    ...
                    className="text-xs font-semibold px-3 py-2 rounded-xl border border-gray-200 bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#6741d9] min-w-[160px]"
                >
    ...
    return (
        <div>
            ...
            {viewingGroup && (() => {
                ...
                return (
                    <>
                        <div className="fixed inset-0 z-[9999] bg-black/50" onClick={() => { setViewingGroup(null); setMenteeSearch(''); setMenteeStatusFilter('All'); }} />
                        <div className="fixed inset-0 z-[10000] flex items-center justify-center p-3 sm:p-6" onClick={() => { setViewingGroup(null); setMenteeSearch(''); setMenteeStatusFilter('All'); }}>
                    ...
                    {CH_NAV.map((item) => (
                        <button key={item.key} onClick={() => { setActiveNav(item.key); setSidebarOpen(false); if (item.key !== 'mentors') setMentorProfilePage(null); }}
                            ...
                            {item.key === 'notifications' && unreadCount > 0 && (
                                <span className="ml-auto text-[11px] font-bold min-w-[20px] h-5 px-1.5 flex items-center justify-center rounded-full bg-[#5b50d6] text-white shrink-0">{unreadCount}</span>
                            )}
                        </button>
                    ))}
                </nav>
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap items-center gap-3 mb-6">
                                ...
                                <select
                                    ...
                                    className="text-xs font-semibold px-3 py-2 rounded-xl border border-gray-200 bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#6741d9] min-w-[130px]"
                                >
                        ...
                        <div>
                            ...
                            <div className="flex flex-wrap items-center gap-3 mb-6">
                                ...
                                <select
                                    ...
                                    className="text-xs font-semibold px-3 py-2 rounded-xl border border-gray-200 bg-white text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#6741d9] min-w-[150px]"
                                >
                                    {statusFilters.map(f => (
