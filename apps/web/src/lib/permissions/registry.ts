...
export const PERMISSIONS = {
  ...
  approvals: {
    ...
    approve_all:    'approvals:approve_all',
    approve_events: 'approvals:approve_events',
  },
  events: {
...
export const ALL_PERMISSIONS: { module: string; action: string; description?: string }[] = [
  ...
  { module: 'approvals',        action: 'approve_events',      description: 'Approve event booking requests' },
  { module: 'events',           action: 'create',              description: 'Create new events' },
