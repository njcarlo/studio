...
export function useUserRole(): UserRoleContextType {
  return usePermissionsStore(
    useShallow((s) => ({
      ...
      myScheduledMinistryIds: s.myScheduledMinistryIds,
      ...
      canViewAllSchedules: s.canViewAllSchedules,
      ...
      canManageContent: s.canManageContent,
      canManagePastoral: s.canManagePastoral,
    })),
  );
}
